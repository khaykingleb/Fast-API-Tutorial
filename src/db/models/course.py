...
class Course(Timestamp, Base):  # NOQA
...
class Section(Timestamp, Base):  # NOQA
...
class ContentBlock(Timestamp, Base):  # NOQA
...
class StudentCourse(Timestamp, Base):  # NOQA
...
class CompletedContentBlock(Timestamp, Base):  # NOQA
